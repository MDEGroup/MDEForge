...
import mdeforge.plugin.eclipse.ui.wizards.GetProjectWizard;
...
public class ActionGetProject implements IObjectActionDelegate {

	private Shell shell;
	
	public ActionGetProject(){
		super();
	}
		...
		if (window != null) {
			...
			if (firstElement instanceof IAdaptable) {
				...
				WizardDialog wizardDialog = new WizardDialog(shell,
						new GetProjectWizard(file, shell));
