...
<div id="dashboard-header" class="row">
	<div class="col-xs-10 col-sm-2">
		<h3>
			<c:if test="${requestScope.create}"><spring:message code="mdeforge.workspace.create.uppercase"/></c:if>
			<c:if test="${requestScope.update}"><spring:message code="mdeforge.workspace.update.uppercase"/></c:if>
			<c:if test="${requestScope.delete}"><spring:message code="mdeforge.workspace.delete.uppercase"/></c:if>
		</h3>
	</div>
