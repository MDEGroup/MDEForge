 ...
 * </p>
 * <ul>
 *   <li>{@link org.mdeforge.emf.metric.impl.AggregatedIntegerMetricImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link org.mdeforge.emf.metric.impl.AggregatedIntegerMetricImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link org.mdeforge.emf.metric.impl.AggregatedIntegerMetricImpl#getMedian <em>Median</em>}</li>
 *   <li>{@link org.mdeforge.emf.metric.impl.AggregatedIntegerMetricImpl#getAverage <em>Average</em>}</li>
 *   <li>{@link org.mdeforge.emf.metric.impl.AggregatedIntegerMetricImpl#getStandardDeviation <em>Standard Deviation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AggregatedIntegerMetricImpl extends MetricImpl implements AggregatedIntegerMetric {
	 ...
	 * @ordered
	 */
	protected static final Integer MINIMUM_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected static final Integer MAXIMUM_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected static final Integer MEDIAN_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected Integer median = MEDIAN_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return MetricPackage.Literals.AGGREGATED_INTEGER_METRIC;
	}
	...
	public void setMinimum(Integer newMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetricPackage.AGGREGATED_INTEGER_METRIC__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setMaximum(Integer newMaximum) {
		...
		maximum = newMaximum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetricPackage.AGGREGATED_INTEGER_METRIC__MAXIMUM, oldMaximum, maximum));
	}
	 ...
	 * @generated
	 */
	public void setMedian(Integer newMedian) {
		Integer oldMedian = median;
		median = newMedian;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetricPackage.AGGREGATED_INTEGER_METRIC__MEDIAN, oldMedian, median));
	}
	...
	public void setAverage(float newAverage) {
		...
		average = newAverage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetricPackage.AGGREGATED_INTEGER_METRIC__AVERAGE, oldAverage, average));
	}
	...
	public void setStandardDeviation(float newStandardDeviation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetricPackage.AGGREGATED_INTEGER_METRIC__STANDARD_DEVIATION, oldStandardDeviation, standardDeviation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetricPackage.AGGREGATED_INTEGER_METRIC__MINIMUM:
				return getMinimum();
			case MetricPackage.AGGREGATED_INTEGER_METRIC__MAXIMUM:
				return getMaximum();
			case MetricPackage.AGGREGATED_INTEGER_METRIC__MEDIAN:
				return getMedian();
			case MetricPackage.AGGREGATED_INTEGER_METRIC__AVERAGE:
				return getAverage();
			case MetricPackage.AGGREGATED_INTEGER_METRIC__STANDARD_DEVIATION:
