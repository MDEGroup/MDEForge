...
public interface WorkspaceService {
	...
	Project addProjectInWorkspace(String idProject, String idWorkspace, User user) throws BusinessException;
	Project addNewProjectInWorkspace(String projectName, String idWorkspace, User user) throws BusinessException;
	...
	void removeProjectInWorkspaces(Project idProject) throws BusinessException;
}
