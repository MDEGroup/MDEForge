...
public class EcorePublicController extends ArtifactPublicController<EcoreMetamodel> {
	...
	@Autowired
	private SimilarityRelationService cosineRelationService;
	@Autowired
...
//			clusters = ecoreMetamodelService.recluster(clu, 0.9, cosineSimilarityRelationService).getClusters();
		...
		case 3:
			...
			clusters = ecoreMetamodelService.getSimilarityClusters(threshold, cosineRelationService).getClusters();
			break;
		case 4:
