...
define('ace/mode/myatl_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/myatl/myatlparse'], function(require, exports, module) {

	var oop = require("../lib/oop");
	var Mirror = require("../worker/mirror").Mirror;
	var myatlparse = require("../mode/myatl/myatlparse");
	
	importScripts("../parser/antlr-all-min.js");
	importScripts("../parser/MyAtlLexer.js");
	importScripts("../parser/MyAtlParser.js");
	...
	(function() {
	    ...
	    this.onUpdate = function() {
		    ...
		    lexer = new MyAtlLexer(cstream);
		    tstream = new org.antlr.runtime.CommonTokenStream(lexer);
		    parser = new MyAtlParser(tstream);
		    try {
		    	parser.rule_Module();
		    } catch(err) {
...
define('ace/mode/myatl/myatlparse', ['require', 'exports', 'module' ], function(require, exports, module) {

(function (root, name, factory) {
   factory(exports)
}(this, 'myatlparse', function (exports) {
