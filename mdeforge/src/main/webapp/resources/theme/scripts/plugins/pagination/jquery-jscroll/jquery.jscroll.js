...
(function($) {
    ...
    var jScroll = function($e, options) {
        ...
        var _data = $e.data('jscroll'),
            ...
            _isWindow = ($e.css('overflow-y') === 'visible') || _options.isWindow,
            _$next = $e.find(_options.nextSelector).first(),
            _$window = $(window),
            _$document = $(document),
            _$scroll = _options.isCustomScroll ? $(_options.customScroll) : (_isWindow ? $(window) : $e),
            _nextHref = _options.contentSelector ? _$next.attr('href') + ' ' + _options.contentSelector : _$next.attr('href');
            
            //alert(_options.isCustomScroll);
        ...
        function _observe() {
            ...
            var $inner = $e.find('div.jscroll-inner').first(),
                ...
                //console.log('jScroll (iTotalHeight): ' + iTotalHeight);
                //console.log('jScroll (inner.outerHeight): ' + $inner.outerHeight());
