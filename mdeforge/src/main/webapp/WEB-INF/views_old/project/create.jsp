...
<div id="dashboard-header" class="row">
	<div class="col-xs-10 col-sm-2">
		<h3>
			<c:if test="${requestScope.create}"><spring:message code="mdeforge.project.create.uppercase"/></c:if>
			<c:if test="${requestScope.update}"><spring:message code="mdeforge.project.update.uppercase"/></c:if>
			<c:if test="${requestScope.delete}"><spring:message code="mdeforge.project.delete.uppercase"/></c:if>
		</h3>
	</div>
...
<div class="col-xs-6 col-md-6">
	<div class="box">
		<div class="box-content">
			<form:form cssClass="form-horizontal" modelAttribute="project" action="${pageContext.request.contextPath}${requestScope.action}" role="form" method="POST">
				<form:hidden path="id" />
				...
				<div class="form-group">
					<label class="col-sm-3 control-label"><spring:message code="mdeforge.workspace.description"/>:</label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<div class="text-center">
						...
						<a href="${pageContext.request.contextPath}/project/list?workspacename=${project.workspace.name}"><button type="button" class="btn btn-warning "><spring:message code="common.action.cancel"/></button></a>
					</div>
				</div>
			</form:form>
		</div>
