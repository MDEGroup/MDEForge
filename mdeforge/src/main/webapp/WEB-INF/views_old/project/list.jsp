											...
											"aoColumns" : [
													...
													},
													{
														...
														"fnRender" : function(oObj) {
															return "<a class=\"col-xs-3\" href='${pageContext.request.contextPath}/project/detail?projectname="
															+ oObj.aData['name']
															+ "'><i class='fa fa-plus-square-o'></i></a>"
															+ "<a class=\"col-xs-3\" href='${pageContext.request.contextPath}/project/update?name="
															+ oObj.aData['name']
															+ "'><i class='fa fa-edit'></i></a>"
															+ "<a class=\"col-xs-3\" href='${pageContext.request.contextPath}/project/delete?name="
															+ oObj.aData['name']
															+ "'><i class='fa fa-trash-o'></i></a>";
														}
													} ],
											"sAjaxSource" : "${pageContext.request.contextPath}/project/findelementspaginated",
											"oLanguage" : {
												"sSearch" : "",
												"sLengthMenu" : '_MENU_',
...
<div id="dashboard-header" class="row">
	<div class="col-xs-10 col-sm-2">
		<h3><spring:message code="mdeforge.projects"/></h3>
	</div>
...
<div class="row">
	<div class="col-xs-12"> 
		<a href="${pageContext.request.contextPath}/project/create?workspacename=${workspacename}"><button type="button" class="btn btn-success"><spring:message code="mdeforge.project.create.lowercase"/></button></a>
	</div>
</div>
<div class="row">
	<div class="col-xs-12">
