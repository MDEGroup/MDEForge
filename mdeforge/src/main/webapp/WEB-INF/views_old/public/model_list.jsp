								...
								.dataTable(
										{
											...
											"aoColumns" : [
													...
													},
													{
														...
														"fnRender" : function(
																oObj) {
															return "<a class=\"col-xs-3\" href='${pageContext.request.contextPath}/defaultworkspace/model/update?name="
																	+ oObj.aData['name']
																	+ "'><i class='fa fa-edit'></i></a>"
																	+ "<a class=\"col-xs-3\" href='${pageContext.request.contextPath}/defaultworkspace/model/delete?name="
																	+ oObj.aData['name']
																	+ "'><i class='fa fa-trash-o'></i></a>";
														}
													} ],
											"sAjaxSource" : "${pageContext.request.contextPath}/defaultworkspace/findmodelspaginated",
											"oLanguage" : {
												"sSearch" : "",
												"sLengthMenu" : '_MENU_',
...
<div id="dashboard-header" class="row">
	<div class="col-xs-10 col-sm-2">
		<h3><spring:message code="mdeforge.models"/></h3>
	</div>
...
<div class="row">
	<div class="col-xs-12"> 
		<a href="${pageContext.request.contextPath}/defaultworkspace/model/create"><button type="button" class="btn btn-success"><spring:message code="mdeforge.model.create.lowercase"/></button></a>
	</div>
</div>
