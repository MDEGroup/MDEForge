...
<div id="dashboard-header" class="row">
	<div class="col-xs-10 col-sm-2">
		<h3>
			<c:if test="${requestScope.create}"><spring:message code="mdeforge.metamodel.create.uppercase"/></c:if>
			<c:if test="${requestScope.update}"><spring:message code="mdeforge.metamodel.update.uppercase"/></c:if>
			<c:if test="${requestScope.delete}"><spring:message code="mdeforge.metamodel.delete.uppercase"/></c:if>
		</h3>
	</div>
...
<div class="col-xs-6 col-md-6">
	<div class="box">
		<div class="box-content">
			<form:form cssClass="form-horizontal" modelAttribute="metamodel" action="${pageContext.request.contextPath}${requestScope.action}" role="form" method="POST" enctype="multipart/form-data">
				<form:hidden path="id" />
				<form:hidden path="project.id" />
				<div class="form-group">
					<label class="col-sm-3 control-label"><spring:message code="mdeforge.metamodel.name"/>:</label>
					<div class="col-sm-9">
						<form:input path="name" cssClass="form-control" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label"><spring:message code="mdeforge.metamodel.description"/>:</label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label"><spring:message code="mdeforge.metamodel.uri"/>:</label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label"><spring:message code="mdeforge.metamodel"/>:</label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					<div class="text-center">
						...
						<a href="${pageContext.request.contextPath}/project/detail?projectname=${metamodel.project.name}"><button type="button" class="btn btn-warning "><spring:message code="common.action.cancel"/></button></a>
					</div>
				</div>
			</form:form>
		</div>
