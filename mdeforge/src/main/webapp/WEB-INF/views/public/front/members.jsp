...
<div class="container-960 innerT">
	...
	<h3 class="glyphicons group margin-none"><i></i>Members</h3>
	<div class="separator bottom"></div>

	<div class="widget widget-heading-simple widget-body-gray">
		<div class="widget-body">
			<p class="lead center margin-none">The model-driven engineering group</p>
				<hr>
				<p class="center margin-none">University of L'Aquila - Computer Science Model Driven Engineering</p>
		</div>
	</div>
			...
			<li class="span4">
				...
				<div class="thumbnail widget-thumbnail">
					...
					<div class="media">
						...
						<!-- <p>
							I'm Assistant Professor at the Department of Information Engineering Computer Science and Mathematics of the University of L'Aquila. My main research interests include Model Driven Engineering (MDE), model transformations, coupled evolution, model differencing, and generative techniques for Web development.
							Currently, I'm working on model difference and model evolution. Moreover, I'm involved in the following European projects:
							OSSMETER (Automated Measurement and Analysis of Open Source Software), IST EU project, FP7
							CHOReOS (Large Scale Choreographies for the Future Internet), IST EU project, FP7
							More details about my professional and research activities can be found here and in my linkedin profile. You can also check out my about.me profile.
							(<a href="http://www.di.univaq.it/diruscio/" target="_blank">continue to my website</a>)
						</p> -->
				...
				<div class="thumbnail widget-thumbnail">
					...
					<div class="caption">
						...
						<!-- <p>
							...
							Experiences on technologies, tools and platforms for web development and traditional development method.
							Currently I'm carrying out research on solving the problem of the automatic chaining of transformations (which uses a centralized repository of artifacts which, in turn, is under study and development).
							Furthermore, I'm working on a web application that allows to perform MDE operations directly on the web.
							(<a href="http://www.basciani.it/" target="_blank">continue to my website</a>)
						</p> -->
