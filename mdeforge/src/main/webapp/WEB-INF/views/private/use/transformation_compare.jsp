...
<ul class="breadcrumb">
	...
	<li>Use</li>
	<li class="divider"></li>
	<li>ATL transformation Compare</li>
</ul>
<!-- Breadcrumb END -->



<h3>ATL transformation Compare</h3>
...
<div class="widget widget-heading-simple widget-body-white">
	...
	<div class="widget-body">
		<form action="${pageContext.request.contextPath}/private/ATLTransformation/transformation_compare" method="POST">
			<div class="row-fluid">
				<div class="span4">
					<table class="table table-bordered table-striped table-white">
						<thead>
							<tr>
								<th>Left ATL transformation</th>
							</tr>
						</thead>
						<tbody>
								<!-- Table row -->
								<tr>
									<td>
										<select class="span12" name="left_metamodel_id">
											<c:forEach items="${transformationList}" var="metamodel">
