		...
		<div class="widget-body">
			...
			<table class="dynamicTable tableTools table table-striped table-bordered table-condensed table-white">
				...
				<tbody>
					...
					<!-- Table row -->
					<tr class="gradeX">						
						<td><a href="${pageContext.request.contextPath}/private/ATLTransformation/transformation_details?transformation_id=${transformation.getId()}">${transformation.getName()}</a></td>
						<td>
						...
						<td class="center actions">
								<a href="${pageContext.request.contextPath}/private/ATLTransformation/transformation_details?transformation_id=${transformation.getId()}" class="btn-action glyphicons eye_open btn-default" title="Transformation Details"><i></i></a>																	
